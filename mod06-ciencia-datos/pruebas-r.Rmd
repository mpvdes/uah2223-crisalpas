...
date: from "2023-04-18" to "2023-07-05"
...
# Tema 1 Rudimentos de R

Para comenzar a trabajar podemos usar los operadores habituales, como la suma, la resta...
Pero también podemos generar funciones.
En concreto, vamos a crear una función que nos diga si el número que tenemos es par o no:
...
Introducimos datos en la función para probarla:
